  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden">
        <p className="text-[14px] font-semibold text-grey-800">The Hayy.AI Advantage</p>
        ...
        <p className="mt-3 text-[15px] leading-normal text-grey-700 sm:text-[16px]">
          Our Smart Agencies are the front line of your success. They understand your projects,
          engage buyers, answer inquiries and convert interest into real opportunities.
        </p>

        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5">
          <StatBlock icon="/images/icons/people.svg" line1="10,000+" line2="Smart Agencies" />
          <StatBlock
            icon="/images/icons/globe-stat.svg"
            line1="80+"
            line2="Countries"
            line3="Global Presence"
          />
          <StatBlock
            icon="/images/icons/protect.svg"
            line1="High-Intent"
            line1b="Buyers"
            line2="Qualified by AI"
            mediumTwoLines
        ...
        <div className="mt-8">
          <div className="mx-auto mb-4 flex w-fit items-center rounded-[15px] border border-black/20 bg-white px-4 py-3 shadow-[0px_0px_2px_rgba(0,0,0,0.25)]">
            <p className="text-[15px] font-semibold text-grey-800 sm:text-[16px]">Buyer Enquiry</p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-center" aria-hidden>
              <svg width="24" height="32" viewBox="0 0 24 32" fill="none">
                <path d="M12 0V28M12 28L6 22M12 28L18 22" stroke="#22b1b7" strokeWidth="2" strokeDasharray="4 4" />
              </svg>
            </div>
      ...
      <div className="relative mx-auto hidden w-full max-w-[1357px] lg:block">
        <div className="relative w-full" style={{ paddingBottom: `${(SECTION_H / SECTION_W) * 100}%` }}>
          <div className="absolute inset-0">
            <div
              className="absolute flex flex-col justify-center gap-[18px]"
              style={{
                left: pos(26, 0).left,
                top: "50%",
            ...
            >
              ...
              <p className="max-w-[557px] text-[16px] leading-normal text-grey-700">
                Our Smart Agencies are the front line of your success. They understand your
                projects, engage buyers, answer inquiries and convert interest into real
                opportunities.
              </p>
            ...
            <div className="absolute" style={pos(848, 41, 446, 94)} data-node-id="35:300">
              <Image
...
function StatBlock({
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <Image src={icon} alt="" width={33} height={33} className="shrink-0" />
      <div className="text-grey-800">
        <p className="text-[16px] font-medium">{line1}</p>
        {line1b && <p className="text-[16px] font-medium">{line1b}</p>}
        <p className="text-[14px]">{line2}</p>
        {line3 && <p className="text-[14px]">{line3}</p>}
      </div>
    </div>
  );
}
