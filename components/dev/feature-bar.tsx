...
export default function FeatureBar() {
	return (
		<section
			className="flex flex-col gap-5 rounded-[10px] border border-black/10 bg-white p-4 shadow-[0px_0px_2px_rgba(0,0,0,0.25)] sm:mt-8 sm:gap-6 lg:flex-row lg:flex-wrap lg:items-center lg:justify-center lg:gap-9"
			data-node-id="6:29"
		>
