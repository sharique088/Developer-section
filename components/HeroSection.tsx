    ...
    >
      <div className="z-10 w-full max-w-[507px] pt-2 sm:pt-8">
        ...
        <p
          ...
          data-node-id="2:40"
        >
          List off-plan projects on Hayy.AI and connect with qualified global buyers through AI
          matching.
        </p>
        <button
          type="button"
        ...
        >
          <span className="flex size-10 shrink-0 items-center justify-center rounded-full border border-secondary bg-[#eff9fa]">
            <img src="/images/robot.svg" alt="" width={20} height={27} className="h-[27px] w-5" />
          </span>
          <span className="text-[16px] font-semibold text-white">Book a Demo</span>
        </button>
      </div>
